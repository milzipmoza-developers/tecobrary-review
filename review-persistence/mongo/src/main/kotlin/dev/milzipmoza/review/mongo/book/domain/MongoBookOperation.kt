...
import dev.milzipmoza.review.mongo.book.mongo.DocumentBookTag
...
class MongoBookOperation(
    ...
    override fun edit(book: Book): Boolean {
        ...
        val updatedDocumentBook = mongoBookRepository.save(DocumentBookMapper.map(documentBook.id, book))
